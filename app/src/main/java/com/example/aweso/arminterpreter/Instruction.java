...
public class Instruction
{
    ...
    public void execute()
    {
        boolean i = true //if another instruction true
       While(i == true)
        {
            if(this.magicTrick.equalsIgnoreCase("ADD"))
            {
                ...
                this.magicTrick = instruction.substring(0, locationOfFirstSpace + 1);
            }
            ...
            else if(this.magicTrick.equalsIgnoreCase("STUR"))
            {
                ...
                int baseAddressValue = baseRegister.getValue();
                int finalMemoryBucket = baseAddressValue + offset;
                ARMap.memory[finalMemoryBucket] = destinationRegister.getValue();
                this.magicTrick = instruction.substring(0, locationOfFirstSpace + 1);
            }
            else
            {
